...
<div class="row">
	<div class="col-lg-6">
		<form method="get" id="form" action="/admin/chat">
	...
	<div class="col-lg-3 pull-right">
		<p class="text-right">
			<a href="<?php echo url('chat/add')?>"><button class="btn btn-primary" type="button">Add</button></a>
		</p>
	</div><!-- /input-group -->
</div><!-- /.col-lg-6 -->
</div>
...
<table class="table table-bordered table-hover table-striped tablesorter">
	<thead>
		<tr>
			...
			<th>Tên Nick <i class="fa fa-sort"></i></th>
			<th>Nick <i class="fa fa-sort"></i></th>
