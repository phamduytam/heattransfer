...
class ChatAR extends BaseAR
{
	...
	public function rules()
	{
		...
		return array(
			...
			*/
			array('name, nick ', 'required', 'message' => 'Vui lòng nhập {attribute} '),
			array('created, phone ', 'safe')
		);
	}
	...
	private function getCriteriaListChat()
	{
		$criteria = new CDbCriteria();
		$criteria->select = '*';
	...
	public function searchListChat($pageSize = 20, $maxPage = -1)
	{
		$criteria = $this->getCriteriaListChat();
		return $this->searchList_Ex($criteria, $pageSize, $maxPage);
	}

	public function findAllListChat()
	{
		$criteria = $this->getCriteriaListChat();
